...
This directory holds all python scripts and files generated during resolution of the assigned tasks by ALX Africa on the topic of Variable Annotations in Python.
